...
class LaunchContractTest(unittest.TestCase):
    ...
    def test_terminal_clearmap_routes_to_mapping_reset(self):
        ...
        self.assertIn('Publisher("/eggy/command/request"', bridge)
    ...
    def test_teb_uses_stable_constrained_omnidirectional_motion(self):
        ...
        self.assertLessEqual(config["max_vel_x"], 0.32)
        self.assertGreaterEqual(config["max_vel_x_backwards"], 0.14)
        self.assertLessEqual(config["max_vel_x_backwards"], 0.16)
        self.assertLessEqual(config["max_vel_y"], 0.08)
        self.assertLessEqual(config["max_vel_y"], config["max_vel_x"] * 0.3)
        self.assertLessEqual(config["max_vel_theta"], 0.65)
        self.assertLessEqual(config["acc_lim_x"], 0.50)
        ...
        self.assertGreaterEqual(config["weight_kinematics_forward_drive"], 18.0)
        self.assertGreaterEqual(config["weight_max_vel_y"], 4.0)
        self.assertGreaterEqual(config["weight_acc_lim_y"], 2.0)
